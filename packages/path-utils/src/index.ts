export function generateTimestampedFileName(extension: string, date: Date): string {
...
export function normalizeFileName(extension: string, getCurrentDate: () => Date, fileName?: string): string {
